<h1 class = 'manager-h1 gold light left w650 align-left'>Select training camp options for <?php echo $boxer['Forname']['name'].' '.$boxer['Surname']['name']?></h1>
...
<div class = 'belts-filter left'>
    ...
    echo '<br/><br/>';
    echo $this->Form->input('venue', array('label' => 'Select Camp', 'options' => $campOptions, 'default' => $boxer['Boxer']['trainer_id']));
