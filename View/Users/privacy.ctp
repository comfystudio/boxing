<h1 class = 'manager-h1 gold light'>Privacy Policy</h1>
...
<div class = 'managers-index'>
    ...
    <div class = 'belts-each-item color1'>
    	<div class = "w976">
        <p>This Privacy Policy governs the manner in which BoxingGame collects, uses, maintains and discloses information collected from users (each, a "User") of the BoxingGame website ("Site"). This privacy policy applies to the Site and all products and services offered by BoxingGame.</p>
    	<br/>
        ...
        <p>BoxingGame may collect and use Users personal information for the following purposes:</p>
        ...
        <p>BoxingGame has the discretion to update this privacy policy at any time. When we do, we will post a notification on the main page of our Site. We encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications.</p>
        <br/>
        ...
        <p>If you have any questions about this Privacy Policy, the practices of this site, or your dealings with this site, please contact us at:</p>
            BoxingGame<br/>
            <a href = '/'>boxing.wtfitness.net</a><br/>
            <p><a href = 'mailto:admin@wtfitness.com'>admin@wtfitness.net</a></p>
		
        <br/>
        <p>This document was last updated on January 25, 2013</p>
        <br/>
